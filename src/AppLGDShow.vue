<template>
    <div>
        ...
        <div style="padding:20px;">
            <div style="font-size:1.5rem;">panelLegends.show</div>
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppLGDShow.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppLGDShow.html" target="_blank" class="item-link">code</a>
        </div>
        ...
        <div style="display:flex; padding-bottom:20px;">
            ...
            <div style="padding:0px 20px;">
                <div>
                    <button style="margin:0px 3px 3px 0px;" @click="opt.panelLegends.show=true">show(default)</button>
                    <button style="margin:0px 3px 3px 0px;" @click="opt.panelLegends.show=false">hide</button>
                </div>
                <WLeafletVue
