<template>
    <div>
        ...
        <div class="bkh">
            <div style="font-size:1.5rem;">pointSet.lineColor</div>
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppPNTPointSetLineColor.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppPNTPointSetLineColor.html" target="_blank" class="item-link">code</a>
        </div>
