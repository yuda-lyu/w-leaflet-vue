<template>
    <div>
        ...
        <div style="padding:20px;">
            ...
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppCTRContourSets.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppCTRContourSets.html" target="_blank" class="item-link">code</a>
        </div>
                ...
                contourSets: [
                    {
                        ...
                        points: [
                            [24.325, 120.786, 5], [23.944, 120.968, 10], [24.884, 121.234, 20], [24.579, 121.345, 78], [24.664, 121.761, 40], [23.803, 121.397, 30],
                            [23.727, 120.772, 2], [23.539, 120.975, 3], [23.612, 121.434, 8],
