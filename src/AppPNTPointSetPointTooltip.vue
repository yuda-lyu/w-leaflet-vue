<template>
    <div>
        ...
        <div class="bkh">
            <div style="font-size:1.5rem;">pointSet.point.tooltip</div>
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppPNTPointSetPointTooltip.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppPNTPointSetPointTooltip.html" target="_blank" class="item-link">code</a>
        </div>
                        ...
                        points: [
                            {
                                ...
                                iconSize: [38, 95],
                                iconAnchor: [22, 94],
                                popupAnchor: [0, -70], //葉子中心
                                tooltip: function(v) {
                                    console.log('pointSet[0].point[0] tooltip', v)
                                    let c = ''
                                    c += '<div style="padding:5px 10px;">'
                                    c += '<div style="color:#222; font-size:0.9rem; margin-bottom:5px; white-space:nowrap;"><span style="color:#f83;">[Tooltip>point]</span> ' + v.point.title + '</div>'
                                    c += '<div style="color:#aaa; white-space:normal;">' + v.point.msg + '</div>'
                                    c += '</div>'
                                    return c
                                },
