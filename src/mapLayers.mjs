let mapLayers = [

    {
        ...
        url: 'https://api.mapbox.com/v4/mapbox.satellite/{z}/{x}/{y}.png?access_token=pk.eyJ1Ijoic2VtaXNwaGVyZSIsImEiOiJja2s1anBrZzMwN3NkMndsOGt6MHo5ajI5In0._vUKnQ57n7UcWsWgOPIEgQ',
        colorShade: 'dark',
        opacity: 1,
        visible: true,
    },
    {
        name: 'OpenStreetMap',
        // url: 'https://{s}.tile.osm.org/{z}/{x}/{y}.png', //同樣位址
    ...
    {
        name: '1987年臺灣地形圖',
        url: 'https://gis.sinica.edu.tw/tileserver/file-exists.php?img=TM100K_1987-png-{z}-{x}-{y}',
        colorShade: '',
        opacity: 1,
        visible: false,
    },
    ...
    //     url: 'https://gis.sinica.edu.tw/taipei/file-exists.php?img=Taipei_aerialphoto_1945-jpg-{z}-{x}-{y}',
    //     visible: false,
    // },
    // {
    //     name: '1945年美軍繪製臺灣城市地圖',
    ...
    {
        name: '1942年日治二萬五千分之一地形圖(昭和修正版)',
        url: 'https://gis.sinica.edu.tw/tileserver/file-exists.php?img=JM25K_1942-png-{z}-{x}-{y}',
        colorShade: '',
        opacity: 1,
        visible: false,
    },
    {
        name: '1939年日治臺灣全圖(第五版)',
        url: 'https://gis.sinica.edu.tw/tileserver/file-exists.php?img=JM300K_1939-png-{z}-{x}-{y}',
        colorShade: '',
        opacity: 1,
        visible: false,
    },
    {
        name: '1934年日治臺灣全圖(第三版)',
        url: 'https://gis.sinica.edu.tw/tileserver/file-exists.php?img=JM300K_1934-jpg-{z}-{x}-{y}',
        colorShade: '',
        opacity: 1,
        visible: false,
    },
    {
        name: '1932年二十萬分一帝國圖(臺灣部份)',
    ...
    {
        name: '1920年日治地形圖(總督府土木局)',
        url: 'https://gis.sinica.edu.tw/tileserver/file-exists.php?img=JM50K_1920-png-{z}-{x}-{y}',
        colorShade: '',
        opacity: 1,
        visible: false,
    },
    ...
    {
        name: '1899年日治臺灣全圖',
        url: 'https://gis.sinica.edu.tw/tileserver/file-exists.php?img=JM400K_1899-png-{z}-{x}-{y}',
        colorShade: '',
        opacity: 1,
        visible: false,
    },
