<template>
    <div>
        ...
        <div class="bkh">
            <div style="font-size:1.5rem;">panelLegends.width</div>
        ...
        <div class="bkp">
            ...
            <div>
                <button style="margin:0px 3px 3px 0px;" @click="opt.panelLegends.width=null">null(default)</button>
                <button style="margin:0px 3px 3px 0px;" @click="opt.panelLegends.width=300">300</button>
            </div>
