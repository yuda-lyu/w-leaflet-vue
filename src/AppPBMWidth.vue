<template>
    <div>
        ...
        <div class="bkh">
            <div style="font-size:1.5rem;">panelBaseMaps.width</div>
        ...
        <div class="bkp">
            ...
            <div>
                <button style="margin:0px 3px 3px 0px;" @click="opt.panelBaseMaps.width=null">null(default)</button>
                <button style="margin:0px 3px 3px 0px;" @click="opt.panelBaseMaps.width=150">150</button>
            </div>
