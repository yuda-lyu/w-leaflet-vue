    ...
    <div>
        ...
        <div style="display:flex; padding-bottom:20px;">
            ...
            <div style="padding:0px 20px;">
                <div>
                    <button style="margin:0px 3px 3px 0px;" @click="opt.panelLegends.maxWidth=300">300(default)</button>
                    <button style="margin:0px 3px 3px 0px;" @click="opt.panelLegends.maxWidth=500">500</button>
                </div>
                <WLeafletVue
