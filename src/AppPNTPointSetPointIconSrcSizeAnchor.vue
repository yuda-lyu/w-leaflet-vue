<template>
    <div>
        ...
        <div class="bkh">
            <div style="font-size:1.5rem;">pointSet.point.iconSrc,iconSize,iconAnchor,popupAnchor,tooltipAnchor</div>
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppPNTPointSetPointIconSrcSizeAnchor.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppPNTPointSetPointIconSrcSizeAnchor.html" target="_blank" class="item-link">code</a>
        </div>
                        ...
                        points: [
                            {
                                ...
                                iconSize: [38, 95],
                                iconAnchor: [22, 94],
                                popupAnchor: [0, -40], //葉子上緣, 此範例用不到
                                tooltipAnchor: [0, -40], //葉子上緣, 此範例用不到
                            ...
                            },
                            {
                                ...
                                latLng: [23.90, 120.97],
                                // type: 'icon', //預設使用pointSet的type='icon'
                        ...
                        points: [
                            {
                                ...
                                latLng: [23.30, 120.57],
                                // type: 'circle', //預設使用pointSet的type='circle'
                            },
                            {
                                title: 'point B-2',
