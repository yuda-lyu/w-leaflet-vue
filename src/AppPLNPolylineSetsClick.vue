<template>
    <div>
        ...
        <div class="bkh">
            <div style="font-size:1.5rem;">polylineSetsClick</div>
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppPLNPolylineSetsClick.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppPLNPolylineSetsClick.html" target="_blank" class="item-link">code</a>
        </div>
    ...
    data: function() {
        return {
            'opt': {
                center: [25, 121.58],
                zoom: 10,
                polylineSetsClick: function(v) {
                    console.log('polylineSetsClick', v)
                },
                polylineSets: [
                    {
                        title: 'polylineSet A',
