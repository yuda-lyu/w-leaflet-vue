<template>
    <div>
        ...
        <div style="padding:20px;">
            <div style="font-size:1.5rem;">pointSet.click</div>
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppPNTPointSetClick.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppPNTPointSetClick.html" target="_blank" class="item-link">code</a>
        </div>
