<template>
    <div>
        ...
        <div style="padding:20px;">
            ...
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppCTRContourSetLegendTextExtra.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppCTRContourSetLegendTextExtra.html" target="_blank" class="item-link">code</a>
        </div>
