<template>
    <div>
        ...
        <div style="padding:20px;">
            <div style="font-size:1.5rem;">polygonSet.click</div>
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppPGNPolygonSetClick.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppPGNPolygonSetClick.html" target="_blank" class="item-link">code</a>
        </div>
    ...
    data: function() {
        return {
            'opt': {
                center: [25, 121.58],
                zoom: 10,
                defPolygonSetsClick: function(v) {
                    console.log('defPolygonSetsClick', v)
                },
                polygonSets: [
                    {
                        title: 'polygonSet A',
                        ...
                        visible: true,
                        click: function(msg) {
                            console.log('polygonSets[0] click', msg)
                        },
                    },
                    {
                        title: 'polygonSet B',
                        ...
                        visible: false,
                        click: function(msg) {
                            console.log('polygonSets[1] click', msg)
                        },
                    },
                ],
            },
