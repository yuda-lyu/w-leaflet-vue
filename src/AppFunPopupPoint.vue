<template>
    <div>
        ...
        <div class="bkp">
            ...
            <div>
                <button style="margin:0px 3px 3px 0px;" @click="toggleLake(0,'show')">show Lakes[0]</button>
                <button style="margin:0px 3px 3px 0px;" @click="toggleLake(1,'show')">show Lakes[1]</button>
                <button style="margin:0px 3px 3px 0px;" @click="toggleLake(null,'hide')">hide popup</button>
            </div>
...
export default {
    ...
    methods: {
        ...
        toggleLake: function(ind, mode) {
            ...
            if (ind === 0) {
                objPoint = {
                    point: vo.opt.pointSets[0].points[0], //第0個point有內建popup事件
                }
            }
            else {
                objPoint = {
                    point: {
                        ...
                        popup: function() { //第1個point沒有先給popup事件而是繼承使用pointSet[0]的popup, 故需另外提供popup事件
                            return '<div style="padding:15px; color:#666; font-size:0.9rem; white-space:nowrap;">custom popup</div>'
                        },
                    },
                }
            }
            ...
            if (mode === 'show') {
                ...
                setTimeout(() => {
                    ...
                    //popupPoint
                    let ele = vo.$refs.wlf.popupPoint(objPoint)
                    console.log('ele', ele) //可基於回傳ele再操作例如高亮指定區域或內容
