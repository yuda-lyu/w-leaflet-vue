<template>
    <div>
        ...
        <div class="bkh">
            ...
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppCTRContourSetGradient.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppCTRContourSetGradient.html" target="_blank" class="item-link">code</a>
        </div>
