<template>
    <div>
        ...
        <div style="padding:20px;">
            <div style="font-size:1.5rem;">polygonSet-changeData</div>
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppPGNPolygonSetChangeData.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppPGNPolygonSetChangeData.html" target="_blank" class="item-link">code</a>
        </div>
        ...
        <div style="display:flex; padding-bottom:20px;">
            ...
            <div style="padding:0px 20px;">
                <div>
                    <button style="margin:0px 3px 3px 0px;" @click="opt.polygonSets[0].latLngs=latLngs1">one polygon</button>
                    <button style="margin:0px 3px 3px 0px;" @click="opt.polygonSets[0].latLngs=latLngs6">complex polygon</button>
                </div>
                <WLeafletVue
...
export default {
    ...
    data: function() {
        ...
        let latLngs6 = [ //此結構代表1個polygon, leaflet可支援
            [ //add p1
                [24.96, 121.41], [25.11, 121.47], [25.06, 121.69], [24.99, 121.61], [24.95, 121.53]
            ],
            [ //c1 XOR p1
        ...
        // let latLngs6 = [ //此結構代表1個multiPolygon, leaflet可支援
        //     [
        //         [ //add p1
        //             [24.96, 121.41], [25.11, 121.47], [25.06, 121.69], [24.99, 121.61], [24.95, 121.53]
        //         ],
