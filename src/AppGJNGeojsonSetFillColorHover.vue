<template>
    <div>
        ...
        <div class="bkh">
            <div style="font-size:1.5rem;">geojsonSet.fillColorHover</div>
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppGJNGeojsonSetFillColorHover.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppGJNGeojsonSetFillColorHover.html" target="_blank" class="item-link">code</a>
        </div>
                ...
                geojsonSets: [
                    {
                        ...
                        fillColorHover: 'rgba(50,100,200,0.7)',
