<template>
    <div>
        ...
        <div style="padding:20px;">
            <div style="font-size:1.5rem;">contourSet.lineColorHover</div>
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppCTRContourSetLineColorHover.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppCTRContourSetLineColorHover.html" target="_blank" class="item-link">code</a>
        </div>
                ...
                contourSets: [
                    {
                        ...
                        lineColorHover: 'rgba(255,255,255,0.5)',
                        visible: true,
                    },
                    {
                        title: 'contourSet B',
