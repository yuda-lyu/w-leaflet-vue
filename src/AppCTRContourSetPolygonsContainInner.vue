<template>
    <div>
        ...
        <div style="padding:20px;">
            ...
            <a href="//yuda-lyu.github.io/w-leaflet-vue/examples/ex-AppCTRContourSetPolygonsContainInner.html" target="_blank" class="item-link">example</a>
            <a href="//github.com/yuda-lyu/w-leaflet-vue/blob/master/docs/examples/ex-AppCTRContourSetPolygonsContainInner.html" target="_blank" class="item-link">code</a>
        </div>
...
export default {
    ...
    data: function() {
        let polygonsContainInner = [ //此結構代表1個polygon, leaflet可支援顯示, 但turf做intersect不支援, 故l-contour會通過toMultiPolygon轉換才能支援
            [
