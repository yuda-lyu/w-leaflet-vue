...
async function main() {
    ...
    //cdn
    let cdn = `<script src="https://cdn.jsdelivr.net/npm/w-leaflet-vue@${pks.version}/dist/w-leaflet-vue.umd.js"></script>`
    ...
    _.each(ltfs, function(v) {
        ...
        //replace
        let r = `<script src="../dist/w-leaflet-vue.umd.js"></script>`
        c = c.replace(r, cdn)
